    ...
    <div class="container py-4">
        ...
        <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem">
                    ...
                    <p class="card-text font-size-14 text-black-50 py-1">
                        ...
                        Veniam beatae possimus ullam assumenda veritatis voluptate
                        illum temporibus, eaque dolore consectetur.
                    </p>
            ...
            <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem">
                    <h5 class="card-title font-size-16">Upcoming Mobiles</h5>
                    <img src="assets/blog/blog2.jpg" alt="blog2" class="card-img-top" />
                    <p class="card-text font-size-14 text-black-50 py-1">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Veniam beatae possimus ullam assumenda veritatis voluptate
                        illum temporibus, eaque dolore consectetur.
            ...
            <div class="item">
                <div class="card border-0 font-rale mr-5" style="width: 18rem">
                    <h5 class="card-title font-size-16">Upcoming Mobiles</h5>
                    <img src="assets/blog/blog3.jpg" alt="blog3" class="card-img-top" />
                    <p class="card-text font-size-14 text-black-50 py-1">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Veniam beatae possimus ullam assumenda veritatis voluptate
                        illum temporibus, eaque dolore consectetur.
