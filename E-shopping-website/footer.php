    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2 col-12">
                ...
                <div class="d-flex flex-column flex-wrap">
                    <a href="#" class="font-rale font-size-14 text-white-50 pb-1">My Acounts</a>
...
<div class="copyright text-center bg-dark text-white py-2">
    <p class="font-rale font-size-14">&copy; CopyRight 2022 Design By <a href="#" class="color-second">ColdCase</a>
    </p>
</div>
<!-- !start #footer -->
